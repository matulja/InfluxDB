...
public class ReadDataTool_ {
  ...
  public ReadDataTool_(final ResultSet resultSet) {

    _resultSet = resultSet;
  }

 public DataRecord_ readLine() throws Exception {
     ...
     if (_resultSet.next()) {
       ...
       _dataRecord = new DataRecord_(measurements, time, precision, fieldKey1, fieldValue1, fieldKey2, fieldValue2, tagsKey, tagsValue);
       return _dataRecord;
     }
else
   return null;
